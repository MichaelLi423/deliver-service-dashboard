...
本课（90 分钟、26 页）工具**按职责讲，不按产品记**：先理解每类工具承担什么职责，具体产品只是实现该职责的示例。三套关键工具深入"是什么/为什么/怎么用"；MCP 只讲边界。页 8–11 使用静态重构材料，项目段打开已有历史会话讲解已有输出。版本一律"以官网/上游为准"，具体数字见 [environment-checklist.md](./environment-checklist.md)。
