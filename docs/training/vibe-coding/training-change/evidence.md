...
> 证据来自 green-final `d304bd5` 当时在 macOS arm64 开发机上的记录，已整理为备课与历史会话不可访问时的兜底材料（阶段边界见 [../demo-runbook.md](../demo-runbook.md)，讲解卡见 [../presenter-preparation.md](../presenter-preparation.md)，核对映射见 [../verify-report.md](../verify-report.md)，评审记录见 [../review-report.md](../review-report.md)）。本文件冻结这些数字与边界，不随当前 HEAD 演进。
